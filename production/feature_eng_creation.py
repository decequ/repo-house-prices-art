...
logging.basicConfig(filename="prod_ml_system.log", encoding="utf-8", filemode="a",
...
def load_n_pre_data():
    ...
    X_train, X_test, y_train, y_test = train_test_split(data_train.drop(
        ['Id', 'SalePrice'], axis=1), data_train['SalePrice'], test_size=0.3, random_state=2025)
